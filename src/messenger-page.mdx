...
<div class="w-screen h-screen bg-whiteSmoke flex flex-col">
  ...
  <div class="_main-wrapper flex-grow flex mx-5 shadow bg-white">
    <div class="_left-sidebar md:w-2/5 lg:w-1/4 hidden md:block">
      <div class="_left-topbar border-b border-mystic mx-6 py-3 h-11 flex items-stretch">
        <button class="btn flex hover:text-blueDark items-center mr-4 px-4 py-3 text-blue text-lg truncate">
          <svg
    ...
    <div class="_middle flex flex-col flex-grow border-l border-r border-mystic">
      ...
      <div class="_composer p-4">
        <div class="_message-input flex border-2 border-iron ">
          <textarea class="rounded w-full flex-grow" />
          <button class="text-blue">Send</button>
        </div>
      </div>
    </div>
    <div class="_right-sidebar w-1/4 hidden lg:block relative">
      <div class="_user-topcard border-b border-mystic pb-7">
        ...
        <div class="text-2 text-center font-semibold">
          Aimee Tran (Utah Jazz Service)
        </div>
