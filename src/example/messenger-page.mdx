...
<div class="w-screen h-screen bg-whiteSmoke flex flex-col">
  ...
  <div class="_main-wrapper flex-grow flex mx-5 shadow bg-white">
    ...
    {/* MIDDLE PART */}
    <div class="_middle flex flex-col flex-grow border-l border-r border-mystic">
      ...
      <div class="_composer p-4">
        ...
        <div class="_actions-bar flex">
          <button class="_attachments btn mr-0 ns:mr-4 uppercase text-sm font-bold flex text-steel hover:bg-whiteSmoke px-4 py-3">
            <svg
            ...
            <span class="hidden ns:inline">Attachments</span>
          </button>
          <button class="_templates btn mr-0 ns:mr-4 uppercase flex text-sm font-bold text-steel hover:bg-whiteSmoke px-4 py-3">
            <svg
              class="fill-current mr-2"
              color="#778692"
              height="16px"
            ...
            <span class="hidden ns:inline">Templates</span>
          </button>
          <button class="_review-invite btn mr-0 ns:mr-4 uppercase flex text-sm font-bold text-steel hover:bg-whiteSmoke px-4 py-3">
            <svg
