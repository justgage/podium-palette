...
<div class="w-screen h-screen bg-whiteSmoke flex flex-col">
  ...
  <div class="_main-wrapper flex-grow flex mx-5 shadow bg-white">
    <div class="_left-sidebar md:flex flex-col md:w-2/5 lg:w-1/3 hidden">
      <div class="_left-sidebar__header border-b border-mystic mx-6 h-11 flex items-stretch  flex-no-shrink">
        <button class="_new-message btn hover:text-blueDark items-center mr-4 px-4 py-3 text-blue text-lg truncate">
          <svg
      ...
      <div class="_left-sidebar__tabs flex border-b border-mystic flex-no-shrink">
      ...
      <div class="_conversation-list relative overflow-auto flex-grow">
        <div class="_item py-5 px-6 border-b border-mystic hover:bg-whiteSmoke">
          <div class="text-jumbo font-bold text-sm"> Marisa Russo </div>
          <div class="border-l-2 px-5 my-2 font-bold border-iron"> Drew Reilly: Hey Marisa, this is Drew… </div>
          <div class="absolute pin-t pin-r m-5 text-xs text-jumbo"> Wednesday </div>
        </div>
        <div class="_item py-5 px-6 border-b border-mystic hover:bg-whiteSmoke">
          <div class="text-jumbo font-bold text-sm"> Marisa Russo </div>
          <div class="border-l-2 px-5 my-2 font-bold border-iron"> Drew Reilly: Hey Marisa, this is Drew… </div>
    ...
    <div class="_right-sidebar w-1/3 hidden lg:block relative">
